            ...
            <div class="col-md-10 col-lg-8">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden mb-4 position-relative">
                    <div class="position-relative">
                        <img src="https://placehold.co/1000x150/lightblue/white?text=" class="card-img-top" alt="..."
                             style="object-fit: cover; height: 320px; filter: brightness(0.7);">
                        <div
                            class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-end p-4"
                            style="pointer-events:none;">
                            <h1 class="display-4 fw-bold text-white mb-2"
                                style="text-shadow: 2px 2px 8px #000;">{{ $article->title }}
                            </h1>
                            <div class="mb-3">
                    ...
                    <div class="card-body bg-white p-4">
                        ...
                        <form action="{{route('comments.store',$article->id)}}" method="post" class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Insert comment" class="form-control rounded-start-pill"
                                       name="content">
                            ...
                            @forelse ($article->comments as $comment)
                                <div class="mb-3 p-3 bg-light rounded-3 border">
                                    <b class="text-primary"><i
                                            class="bi bi-person-circle me-1"></i>{{$comment->user->name}}{{ auth()->check() && $comment->user_id === auth()->id() ? ' (you)' : '' }}
                                        :</b>
