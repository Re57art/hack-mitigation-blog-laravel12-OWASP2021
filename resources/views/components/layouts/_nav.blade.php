<nav class="navbar navbar-expand-lg position-sticky top-0 w-100"
     style="background: #fff; border-bottom: 1.5px solid #e3e6ea; z-index: 1000; box-shadow: 0 2px 12px 0 rgba(0,0,0,0.03);">
    <div class="container-fluid py-2">
        <a class="navbar-brand fw-bold fs-3 text-primary d-flex align-items-center gap-2" href="{{route('home')}}"
           style="letter-spacing: 1px;">
            <span class="logo-circle d-flex align-items-center justify-content-center"><i
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a class="nav-link fw-semibold fs-5 px-3 text-primary nav-underline position-relative" aria-current="page" href="{{route('home')}}">Home</a>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-semibold fs-5 px-3 text-primary nav-underline position-relative"
                ...
                <li class="nav-item ms-lg-2 mt-2 mt-lg-0">
                    <a class="btn start-writing-nav-btn d-flex align-items-center px-4 py-2 fw-bold shadow-sm"
            ...
            <ul class="navbar-nav ms-lg-2">
                <li class="nav-item dropdown">
                    @guest
                        <a class="nav-link dropdown-toggle fw-semibold text-primary d-flex align-items-center gap-2"
                   ...
                   style="width:100%;height:100%;object-fit:cover;border-radius:50%;display:block;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end custom-dropdown">
                            ...
                            <form action="/logout" method="POST">
                                @csrf
                                <button type="submit" class="dropdown-item"><i class="bi bi-box-arrow-right me-2"></i>Logout
                                </button>
                            </form>
                        </ul>
                    @endauth
